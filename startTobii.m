%Start Tobii recording for the psychophys epxeriment (look at SDK for api
...
%ADDRESS OF THE EYETRACKER (Kat laptop+glasses 081117) [fe80::76fe:48ff:fe19:fbaf]
%use discover glasses on network in ubuntu to get the address and check
%using http requester firefox
apiCmd = 'system/conf';
data = struct('sys_ec_preset','Indoor');
